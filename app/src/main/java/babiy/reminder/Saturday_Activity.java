...
public class Saturday_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Task> listTask = db.getAllTasks("SATURDAY");
        String temp;
        for (Task ts : listTask) {
            temp = ts.getDay();
            if (temp.equals("SATURDAY")) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK){
            ...
            if (requestCode == 1){
                ...
                db.addTask(new Task(task ,"SATURDAY"));
                recreate();
            }
        }
    }
